...
public interface CitaPrimerContactoRepository extends JpaRepository<CitaPrimerContacto, Long> {

    List<CitaPrimerContacto> findByQuejaIdOrderByFechaCitaDescHoraCitaDesc(Long quejaId);

    List<CitaPrimerContacto> findByFolioOrderByFechaCitaDescHoraCitaDesc(String folio);

    List<CitaPrimerContacto> findByFechaCitaOrderByHoraCitaAsc(LocalDate fechaCita);
