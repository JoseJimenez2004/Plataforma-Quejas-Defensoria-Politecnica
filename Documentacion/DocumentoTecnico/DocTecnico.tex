...
\usepackage{makecell}         % Para saltos de línea en celdas de tablas
...
\begin{table}[H]
    ...
    \begin{tabular}{>{\bfseries\raggedright\arraybackslash}p{3.2cm} p{10.5cm}}
    \toprule
...
\begin{table}[H]
    ...
    \small
    \begin{tabular}{>{\raggedright\arraybackslash}p{3.4cm} >{\centering\arraybackslash}p{1.9cm} >{\centering\arraybackslash}p{1.9cm} >{\centering\arraybackslash}p{1.9cm} >{\centering\arraybackslash}p{1.9cm} >{\centering\arraybackslash}p{1.9cm}}
    \toprule
    \textbf{Característica} &
    \makecell{\textbf{Bully}\\\textbf{Button}} &
    \makecell{\textbf{Ventanilla}\\\textbf{Escolar}} &
    \makecell{\textbf{Alerta}\\\textbf{IPN}} &
    \makecell{\textbf{UNAM}\\\textbf{Denuncia}} &
    \makecell{\textbf{PROFEDET}\\\textbf{Digital}} \\
    \midrule
    Plataforma Web               & Sí & Sí & Sí & Sí & Sí \\
    \addlinespace
    Registro de queja formal     & Sí & Sí & No & Sí & Sí \\
    \addlinespace
