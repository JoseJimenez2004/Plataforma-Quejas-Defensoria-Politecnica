...
\title{\textbf{Catálogo de Requerimientos y Reglas de Negocio}\\
\large Plataforma Web DDP-IPN}
\date{}
...
\rowcolor[HTML]{F2F4F7}
RNF-03 & Cifrado de datos personales y evidencias en reposo utilizando el estándar AES-256 (\texttt{pgcrypto}). & Seguridad \\
...
\begin{table}[H]
\centering
\caption{RNF — Atributos de Rendimiento, Eficiencia y Escalabilidad.}
\begin{tabularx}{\textwidth}{@{} l L l @{}}
\toprule
\rowcolor[HTML]{2D3E50}
\textbf{\color{white} ID} & \textbf{\color{white} Descripción del Atributo} & \textbf{\color{white} Categoría} \\ \midrule
...
\textbf{\color{white} ID} & \textbf{\color{white} Descripción del Atributo} & \textbf{\color{white} Categoría} \\ \midrule
\rowcolor[HTML]{F2F4F7}
RNF-12 & El sistema debe garantizar una disponibilidad del 99.5\,\% (\textit{Uptime}) durante el calendario escolar del IPN. & Disponibilidad \\
...
RNF-15 & El sistema debe realizar respaldos automáticos diarios (\textit{Backups}) del repositorio digital de evidencias. & Recuperación \\ \bottomrule
\end{tabularx}
\end{table}
...
RNF-19 & El sistema debe ser compatible con los navegadores modernos (Chrome, Firefox, Edge) mediante un diseño \textit{responsive}. & Compatibilidad \\ \bottomrule
\end{tabularx}
\end{table}
