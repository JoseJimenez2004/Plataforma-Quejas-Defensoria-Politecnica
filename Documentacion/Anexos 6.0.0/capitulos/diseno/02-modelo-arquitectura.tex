...
\begin{itemize}
    \item \textbf{Interfaz de Usuario (Angular):} Gestiona la interacción reactiva con el quejoso y el personal de la DDP. Utiliza servicios inyectables para realizar peticiones asíncronas hacia el backend, manejando estados de carga y errores de red.
