...
título & VARCHAR(255) & NOT NULL & Encabezado o asunto del mensaje. \\ \hline
...
código\_folio & VARCHAR(255) & UNIQUE, NOT NULL & Folio p\'ublico generado para el seguimiento. \\ \hline
...
descripción & TEXT & - & Descripci\'on detallada de los hechos denunciados. \\ \hline
...
teléfono\_tutor & VARCHAR(20) & - & Tel\'efono de contacto del tutor. \\ \hline
\end{tabularx}
...
código\_folio & VARCHAR(50) & - & Referencia textual del folio (redundancia controlada). \\ \hline
...
descripción & VARCHAR(255) & NOT NULL & Detalle del evento o acci\'on realizada. \\ \hline
...
descripción & VARCHAR(255) & - & Explicaci\'on detallada del estado. \\ \hline
\end{tabularx}
...
INSERT INTO cat_estatus_queja (nombre, descripción) VALUES 
...
descripción & VARCHAR(255) & - & Descripci\'on detallada del tema. \\ \hline
\end{tabularx}
...
INSERT INTO cat_tema (nombre, descripción) VALUES 
...
descripción & VARCHAR(255) & - & Descripci\'on del prop\'osito del documento. \\ \hline
\end{tabularx}
...
INSERT INTO cat_tipo_documento (nombre, descripción) VALUES 
