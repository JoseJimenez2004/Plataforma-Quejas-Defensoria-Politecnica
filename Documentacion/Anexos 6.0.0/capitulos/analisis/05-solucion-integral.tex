...
\begin{itemize}
    \item \textbf{Perspectiva del Quejoso:} El sistema ofrece un canal de comunicación donde la comunidad politécnica puede registrar su queja y recibir un folio digital. Esto otorga certidumbre al usuario, quien puede consultar el departamento exacto en el que se encuentra su trámite.
