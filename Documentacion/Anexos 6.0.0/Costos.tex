...
\title{\textbf{Análisis Detallado de Costos del Proyecto (12 meses)}\\
...
\section{Inversión en Hardware (Pago Único)}
...
\section{Gastos Operativos Individuales (Mensuales)}
...
\section{Licenciamiento y Herramientas Especializadas}
...
\section{Resumen Consolidado de la Inversión}
