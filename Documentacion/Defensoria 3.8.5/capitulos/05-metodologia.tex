...
\begin{itemize}
    ...
    \item \textbf{Visualización del Trabajo (WIP):} Mediante un tablero Kanban, se limita el trabajo en curso (\textit{Work In Progress}), lo que asegura que el equipo (Bastian, Jair y Anthony) se enfoque en terminar tareas antes de iniciar nuevas.
...
\textit{Development Team} & Anthony, Bastian y Jair; responsables del diseño, codificación de microservicios, entrenamiento del modelo PLN y pruebas. \\ \hline
\end{tabular}
\caption{Distribución de roles bajo la metodología Scrum-ban.}
\end{table}

\section{Herramientas de Apoyo}
Para la implementación efectiva de esta metodología, se utilizan las siguientes herramientas:
\begin{itemize}
    \item \textbf{GitHub Projects:} Para la gestión del tablero Kanban y el control de versiones.
    \item \textbf{Discord / Slack:} Para la comunicación síncrona y coordinación diaria.
    \item \textbf{Docker:} Para garantizar que el incremento desarrollado funcione de manera idéntica en todos los entornos de prueba.
\end{itemize}