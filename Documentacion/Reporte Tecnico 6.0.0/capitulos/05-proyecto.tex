...
La propuesta consiste en el desarrollo de una plataforma web integral orientada a la gestión digital de quejas y denuncias para la DDP del IPN. El sistema tiene como finalidad optimizar los procesos institucionales relacionados con el registro, validación, seguimiento, análisis y resolución de expedientes, mediante el uso de tecnologías de automatización, centralización documental y análisis inteligente de información.
...
La arquitectura propuesta \ref{fig:arquitectura_general} contempla la separación de responsabilidades mediante servicios independientes especializados, permitiendo desacoplar los procesos administrativos, la gestión documental, el manejo de usuarios y el componente inteligente de clasificación automática.
...
\footnote{Para mayores especificaciones, consultar el \textbf{Anexo Costos}.}
...
Los riesgos identificados se clasifican en diferentes categorías (Tabla \ref{tab:clasificacion_riesgos}) con base en el impacto que podrían generar sobre la operación de la plataforma.
...
\footnote{Para mayores especificaciones, consultar el \textbf{Anexo Análisis de riesgo}.}
