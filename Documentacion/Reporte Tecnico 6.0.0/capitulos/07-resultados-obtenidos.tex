...
Durante el desarrollo del proyecto se implementaron distintos módulos funcionales mostrados en la tabla \ref{tab:modulos_implementados} enfocados en cubrir las necesidades operativas y administrativas identificadas durante el análisis del problema.
...
Los resultados obtenidos (Tabla \ref{tab:resultados_clasificador}) permitieron validar la viabilidad del uso de técnicas de Procesamiento de Lenguaje Natural y aprendizaje automático como apoyo al análisis inicial de expedientes.
...
Los resultados obtenidos durante las pruebas funcionales (\ref{tab:pruebas_funcionales})permitieron validar el comportamiento esperado de los principales componentes del sistema y verificar la integración correcta entre frontend, backend y base de datos.
