...
\bibitem{41}
Imagina Formación, \textit{``Conoce las ventajas de utilizar Angular''}, imaginaformación.com. [En línea]. Disponible: \url{https://imaginaformacion.com/tutoriales/conoce-las-ventajas-de-utilizar-angular}. [Accedido: 10-abr-2026].
...
T. G. Dietterich, \textit{``Ensemble Methods in Machine Learning''}, en
\textit{Multiple Classifier Systems. MCS 2000. Lecture Notes in Computer Science},
vol. 1857, pp. 1--15, Berlín, Alemania: Springer, 2000.
DOI: \url{https://doi.org/10.1007/3-540-45014-9_1}

\bibitem{manning2008}
C. D. Manning, P. Raghavan e H. Schütze, \textit{Introduction to Information
Retrieval}. Cambridge, Reino Unido: Cambridge University Press, 2008.
Disponible en: \url{https://nlp.stanford.edu/IR-book/}

\bibitem{huggingface2023}
HuggingFace, \textit{``paraphrase-multilingual-mpnet-base-v2''},
HuggingFace Model Hub, 2023. Disponible en:
\url{https://huggingface.co/sentence-transformers/paraphrase-multilingual-mpnet-base-v2}

\bibitem{jurafsky2023}
D. Jurafsky y J. H. Martin, \textit{Speech and Language Processing}, 3.ª ed.
(borrador). Stanford University, 2023. Disponible en:
