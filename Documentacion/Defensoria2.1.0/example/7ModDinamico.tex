...
\begin{UCtrayectoria}
	...
	\UCpaso [\UCactor] Presiona el icono \IUbutton{Buscar}. \label{HR-PR-IU1:Materias}
	...
	\UCpaso [\UCsist]  Habilita los iconos \IUbutton{Registrar} y \IUbutton{Eliminar}.
...
\begin{UCtrayectoriaA}[Fin de la trayectoria]{C}{El actor desea editar o eliminar.}
	\UCpaso [\UCactor] Presiona el icono \IUbutton{Registrar}. \refTray{C1}
...
\begin{UCtrayectoriaA}[Fin de la trayectoria]{C1}{El actor desea editar o eliminar.}
	\UCpaso [\UCactor] Presiona el icono \IUbutton{Eliminar}.
