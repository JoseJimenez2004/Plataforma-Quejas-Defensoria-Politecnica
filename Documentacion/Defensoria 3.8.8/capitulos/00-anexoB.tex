...
\begin{figure}[htbp]
    ...
    \figCUuno 
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU01.}
    \label{fig:cu01}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \figCUdos 
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU02.}
    \label{fig:cu02}
\end{figure}
...
\begin{itemize}[leftmargin=*]
    ...
    \end{itemize}
    \item \textbf{Trayectoria C: Cuenta bloqueada por múltiples intentos fallidos} \\
    \textit{Condición:} Se superan los 5 intentos fallidos de inicio de sesión.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema bloquea la cuenta temporalmente (30 minutos).
        \item[C-2:] El sistema muestra el mensaje \hyperlink{msg:MSG07}{MSG07}.
        \item \textbf{Retorno:} El sistema sugiere esperar o usar recuperación de contraseña.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUtres
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU03.}
    \label{fig:cu03}
\end{figure}
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Correo no registrado} \\
    \textit{Condición:} El correo ingresado no existe en la base de datos.
    \begin{itemize}[nosep]
        \item[A-1:] El sistema muestra el mensaje \hyperlink{msg:MSG03}{MSG03}.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
    ...
    \end{itemize}
    \item \textbf{Trayectoria C: Contraseña débil} \\
    \textit{Condición:} La nueva contraseña no cumple los criterios de seguridad.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema valida la complejidad (mín. 8 caracteres, mayúscula, número, símbolo).
        \item[C-2:] El sistema muestra mensaje específico de error.
        \item \textbf{Retorno:} Regresa al punto 7 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUcuatro
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU04.}
    \label{fig:cu04}
\end{figure}
...
\begin{itemize}[leftmargin=*]
    ...
    \end{itemize}
    \item \textbf{Trayectoria B: Formato de teléfono inválido} \\
    \textit{Condición:} El teléfono ingresado no cumple el formato esperado.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema detecta el formato incorrecto.
        \item[B-2:] El sistema muestra mensaje de error específico.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Cancelar edición} \\
    \textit{Condición:} El actor decide no guardar los cambios.
    \begin{itemize}[nosep]
        \item[C-1:] El actor selecciona "Cancelar".
        \item[C-2:] El sistema descarta los cambios y refresca con datos originales.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUcinco
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU05.}
    \label{fig:cu05}
\end{figure}
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}[nosep]
        ...
        \item \textbf{Retorno:} Termina el caso de uso y retorna al origen.
    \end{itemize}
    \item \textbf{Trayectoria B: Datos de contacto del tutor inválidos} \\
    \textit{Condición:} El correo o teléfono del tutor tienen formato incorrecto.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema resalta los campos con error.
        \item[B-2:] El sistema muestra el mensaje \hyperlink{msg:MSG15}{MSG15}.
        \item \textbf{Retorno:} Regresa al punto 4 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Tutor duplicado (mismo que el usuario)} \\
    \textit{Condición:} Se intenta registrar al mismo menor como su propio tutor.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema detecta que correo del tutor = correo del usuario.
        \item[C-2:] El sistema muestra mensaje de error específico.
        \item \textbf{Retorno:} Regresa al punto 4 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUseis
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU06.}
    \label{fig:cu06}
\end{figure}
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}[nosep]
        ...
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectoria B: Descripción insuficiente} \\
    \textit{Condición:} La descripción de hechos tiene menos de 20 caracteres.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema identifica la longitud insuficiente.
        \item[B-2:] El sistema muestra el mensaje \hyperlink{msg:MSG19}{MSG19}.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Fecha de hechos inválida} \\
    \textit{Condición:} La fecha ingresada es futura o anterior a la creación de la cuenta.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema detecta la inconsistencia temporal.
        \item[C-2:] El sistema muestra el mensaje \hyperlink{msg:MSG21}{MSG21}.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUsiete
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU07.}
    \label{fig:cu07}
\end{figure}
...
\begin{enumerate}[nosep]
    ...
    \item El sistema valida el formato (.pdf, .jpg, .png, .mp3, .mp4) (\hyperlink{msg:MSG23}{Trayectoria A}).
    \item El sistema verifica que el peso no supere los 15MB (\hyperlink{msg:MSG24}{Trayectoria B}).
    \item El sistema analiza el archivo en busca de malware (\hyperlink{err:E12}{Error E1}).
    \item El sistema verifica la cuota de almacenamiento del usuario (\hyperlink{err:E13}{Error E2}).
...
\begin{itemize}[leftmargin=*]
    ...
    \textit{Condición:} El actor intenta subir un formato no seguro (ej. .exe, .sh, .bat).
    \begin{itemize}[nosep]
    ...
    \end{itemize}
    \item \textbf{Trayectoria B: Tamaño de archivo excedido} \\
    \textit{Condición:} El archivo seleccionado supera el límite de 15MB.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema interrumpe la carga y muestra \hyperlink{msg:MSG24}{MSG24}.
        \item \textbf{Retorno:} Regresa al punto 2 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Archivo corrupto o infectado} \\
    \textit{Condición:} El análisis de seguridad detecta malware o el archivo está dañado.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema rechaza la carga.
        \item[C-2:] El sistema muestra el mensaje \hyperlink{msg:MSG25}{MSG25}.
        \item \textbf{Retorno:} Regresa al punto 2 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria D: Cuota de almacenamiento excedida} \\
    \textit{Condición:} El usuario ha superado su límite de almacenamiento (100MB).
    \begin{itemize}[nosep]
        \item[D-1:] El sistema detecta la superación de cuota.
        \item[D-2:] El sistema muestra el mensaje \hyperlink{msg:MSG26}{MSG26}.
        \item[D-3:] El sistema sugiere eliminar evidencias antiguas.
        \item \textbf{Retorno:} Regresa al punto 2 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria E: Eliminar evidencia adjunta} \\
    \textit{Condición:} El actor decide remover un archivo antes del envío.
    \begin{itemize}[nosep]
        \item[E-1:] El actor selecciona "Eliminar" junto al archivo.
        \item[E-2:] El sistema solicita confirmación mediante \hyperlink{msg:MSG27}{MSG27}.
        \item[E-3:] El actor confirma la eliminación.
        \item[E-4:] El sistema libera el espacio y actualiza la base de datos.
        \item \textbf{Retorno:} Regresa al punto 8 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUocho
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU08.}
    \label{fig:cu08}
\end{figure}
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}[nosep]
        \item[B-1:] El actor selecciona criterios de filtro en el tablero.
        \item[B-2:] El sistema actualiza la consulta con los parámetros seleccionados.
        \item[B-3:] El sistema muestra los resultados coincidentes.
        \item \textbf{Retorno:} Regresa al punto 5 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Ordenamiento de resultados} \\
    \textit{Condición:} El actor desea ordenar la lista por fecha o estatus.
    \begin{itemize}[nosep]
        \item[C-1:] El actor selecciona la columna por la cual ordenar.
        \item[C-2:] El sistema reordena la tabla (ascendente/descendente alternado).
        \item \textbf{Retorno:} Regresa al punto 5 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria D: Error de conexión con la base de datos} \\
    \textit{Condición:} La consulta excede el tiempo de espera o falla la conexión.
    \begin{itemize}[nosep]
        \item[D-1:] El sistema detecta el timeout o error de conexión.
        \item[D-2:] El sistema muestra el mensaje \hyperlink{msg:MSG29}{MSG29}.
        \item[D-3:] El sistema sugiere recargar la página o intentar más tarde.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectorias de Extensión:}
    \begin{itemize}[nosep]
        \item \textbf{Edición:} Si selecciona "Borrador", habilita enlace al \textbf{CU09}.
        \item \textbf{Notificación:} Si hay avisos nuevos, habilita enlace al \textbf{CU11}.
        \item \textbf{Detalle:} Si selecciona cualquier trámite, habilita enlace al \textbf{CU18}.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUnueve
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU09.}
    \label{fig:cu09}
\end{figure}
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Descripción insuficiente al enviar} \\
    \textit{Condición:} La descripción modificada tiene menos de 20 caracteres.
    \begin{itemize}[nosep]
        \item[A-1:] El sistema detecta la longitud insuficiente.
        \item[A-2:] El sistema muestra el mensaje \hyperlink{msg:MSG19}{MSG19}.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria B: Fecha de hechos inválida} \\
    \textit{Condición:} La fecha modificada es futura.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema detecta la inconsistencia temporal.
        \item[B-2:] El sistema muestra el mensaje \hyperlink{msg:MSG21}{MSG21}.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Cancelar edición} \\
    \textit{Condición:} El actor decide no guardar los cambios realizados.
    \begin{itemize}[nosep]
        \item[C-1:] El actor selecciona "Cancelar".
        \item[C-2:] El sistema descarta los cambios y retorna al tablero \textbf{[GQ]-UI03}.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUdiez
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU10.}
    \label{fig:cu10}
\end{figure}
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Cancelar eliminación} \\
    \textit{Condición:} El actor cambia de opinión en el mensaje de confirmación.
    \begin{itemize}[nosep]
        \item[A-1:] El actor selecciona "Cancelar" en el diálogo de confirmación.
        \item[A-2:] El sistema cierra el diálogo sin realizar cambios.
        \item \textbf{Retorno:} Regresa al tablero \textbf{[GQ]-UI03} sin eliminar.
    \end{itemize}
    \item \textbf{Trayectoria B: Intento de eliminar queja no borrador} \\
    \textit{Condición:} El estatus del trámite cambió entre la selección y la confirmación.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema detecta que el estatus ya no es "Borrador".
        \item[B-2:] El sistema muestra el mensaje de error \hyperlink{err:E15}{E1}.
        \item \textbf{Retorno:} Regresa al tablero \textbf{[GQ]-UI03} sin eliminar.
    \end{itemize}
    \item \textbf{Trayectoria C: Error en la eliminación de archivos adjuntos} \\
    \textit{Condición:} Fallo al eliminar evidencias del repositorio de almacenamiento.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema intenta eliminar la queja pero falla en los adjuntos.
        \item[C-2:] El sistema registra el error en el log y revierte la operación.
        \item[C-3:] El sistema muestra mensaje de error genérico.
        \item \textbf{Retorno:} Regresa al tablero \textbf{[GQ]-UI03} sin eliminar.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUonce
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU11.}
    \label{fig:cu11}
\end{figure}
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Notificación de tipo informativo} \\
    \textit{Condición:} La notificación solo informa un cambio de estatus sin requerir acción.
    \begin{itemize}[nosep]
        \item[A-1:] El actor lee el contenido de la notificación.
        \item[A-2:] El sistema solo marca como leída y cierra.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectoria B: Error al marcar como leída} \\
    \textit{Condición:} Fallo en la actualización del estado de la notificación.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema detecta el error de persistencia.
        \item[B-2:] El sistema muestra el mensaje \hyperlink{msg:MSG31}{MSG31}.
        \item[B-3:] El sistema permite reintentar la operación.
        \item \textbf{Retorno:} Regresa al punto 4 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Múltiples notificaciones del mismo trámite} \\
    \textit{Condición:} Existen varias notificaciones sin leer para un mismo folio.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema agrupa las notificaciones por trámite.
        \item[C-2:] El actor puede expandir el grupo para ver el historial.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUdoce
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU12.}
    \label{fig:cu12}
\end{figure}
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Envío sin realizar cambios} \\
    \textit{Condición:} El actor intenta reenviar sin modificar nada.
    \begin{itemize}[nosep]
        \item[A-1:] El sistema detecta que no hay cambios en los campos requeridos.
        \item[A-2:] El sistema muestra el mensaje \hyperlink{msg:MSG34}{MSG34}.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria B: Vencimiento del plazo para subsanar} \\
    \textit{Condición:} El actor intenta responder después del plazo establecido.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema verifica la fecha de vencimiento del requerimiento.
        \item[B-2:] El sistema muestra mensaje indicando que el plazo expiró.
        \item[B-3:] El sistema informa que el trámite podría ser desechado.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectoria C: Guardar progreso de subsanación} \\
    \textit{Condición:} El actor desea guardar parcialmente las correcciones.
    \begin{itemize}[nosep]
        \item[C-1:] El actor selecciona "Guardar Progreso".
        \item[C-2:] El sistema almacena los cambios sin cambiar el estatus.
        \item[C-3:] El sistema muestra mensaje de confirmación.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUtrece
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU13.}
    \label{fig:cu13}
\end{figure}
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Error en la generación del PDF} \\
    \textit{Condición:} Fallo en el servicio de generación de documentos.
    \begin{itemize}[nosep]
        \item[A-1:] El sistema detecta el error en la generación.
        \item[A-2:] El sistema muestra el mensaje \hyperlink{msg:MSG35}{MSG35}.
        \item[A-3:] El sistema sugiere intentar nuevamente o contactar soporte.
        \item \textbf{Retorno:} Regresa al punto 2 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria B: Visualización sin descarga} \\
    \textit{Condición:} El actor solo desea leer el resumen sin descargar el PDF.
    \begin{itemize}[nosep]
        \item[B-1:] El actor lee el contenido resumido en la pantalla.
        \item[B-2:] El actor selecciona "Cerrar" o "Volver".
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectoria C: Múltiples medidas precautorias} \\
    \textit{Condición:} Existen varias medidas dictadas para el mismo trámite.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema despliega una lista de todas las medidas emitidas.
        \item[C-2:] El actor selecciona la medida específica a consultar.
        \item \textbf{Retorno:} Regresa al punto 2 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUcatorce
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU14.}
    \label{fig:cu14}
\end{figure}
...
\begin{enumerate}[nosep]
    ...
    \item El sistema presenta los botones de acción: \textbf{Aceptar Propuesta} e \textbf{Inconformarse / Rechazar}.
    \item Dependiendo de la elección, el sistema invoca al \textbf{CU15} o \textbf{CU16}.
\end{enumerate}

\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Propuesta ya respondida} \\
    \textit{Condición:} El actor intenta acceder a una propuesta ya aceptada o rechazada.
    \begin{itemize}[nosep]
        \item[A-1:] El sistema detecta que ya existe una respuesta previa.
        \item[A-2:] El sistema muestra el mensaje \hyperlink{msg:MSG36}{MSG36}.
        \item[A-3:] El sistema solo permite visualizar, no modificar la decisión.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectoria B: Propuesta vencida} \\
    \textit{Condición:} El plazo para responder a la propuesta ha expirado.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema verifica la fecha de vencimiento.
        \item[B-2:] El sistema muestra mensaje indicando que el plazo expiró.
        \item[B-3:] El sistema informa que el trámite continuará por vía administrativa.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectoria C: Descargar propuesta completa} \\
    \textit{Condición:} El actor desea descargar el documento oficial de la propuesta.
    \begin{itemize}[nosep]
        \item[C-1:] El actor selecciona "Descargar Propuesta".
        \item[C-2:] El sistema genera y descarga el PDF con los términos completos.
        \item \textbf{Retorno:} Regresa al punto 3 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUquince
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU15.}
    \label{fig:cu15}
\end{figure}
...
\begin{enumerate}[nosep]
    ...
    \item El sistema genera automáticamente el acta de acuerdo con sello digital (\hyperlink{err:E20}{Error E1}).
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Cancelar aceptación} \\
    \textit{Condición:} El actor cambia de opinión en el paso de confirmación.
    \begin{itemize}[nosep]
        \item[A-1:] El actor selecciona "Cancelar" en el diálogo de confirmación.
        \item[A-2:] El sistema cierra el diálogo sin realizar cambios.
        \item \textbf{Retorno:} Regresa al \hyperlink{anexo:casos_uso}{CU14}.
    \end{itemize}
    \item \textbf{Trayectoria B: Error al generar el acta de cierre} \\
    \textit{Condición:} Fallo en el servicio de generación de documentos.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema detecta el error en la generación del acta.
        \item[B-2:] El sistema muestra el mensaje \hyperlink{msg:MSG38}{MSG38}.
        \item[B-3:] El sistema registra el error y mantiene el estatus.
        \item[B-4:] El sistema notifica al soporte técnico.
        \item \textbf{Retorno:} Termina el caso de uso sin completar la aceptación.
    \end{itemize}
    \item \textbf{Trayectoria C: Aceptación con condiciones} \\
    \textit{Condición:} El actor desea agregar observaciones a su aceptación.
    \begin{itemize}[nosep]
        \item[C-1:] El actor selecciona "Agregar Observaciones".
        \item[C-2:] El sistema muestra un campo de texto para observaciones.
        \item[C-3:] El actor ingresa sus observaciones.
        \item \textbf{Retorno:} Regresa al punto 2 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUdieciseis
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU16.}
    \label{fig:cu16}
\end{figure}
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Cancelar rechazo} \\
    \textit{Condición:} El actor cambia de opinión antes de confirmar.
    \begin{itemize}[nosep]
        \item[A-1:] El actor selecciona "Cancelar" o "Volver".
        \item[A-2:] El sistema cierra el formulario sin realizar cambios.
        \item \textbf{Retorno:} Regresa al \hyperlink{anexo:casos_uso}{CU14}.
    \end{itemize}
    \item \textbf{Trayectoria B: Error al actualizar el estatus} \\
    \textit{Condición:} Fallo en la persistencia del cambio de estatus.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema detecta el error en la actualización.
        \item[B-2:] El sistema muestra el mensaje \hyperlink{msg:MSG40}{MSG40}.
        \item[B-3:] El sistema revierte cualquier cambio parcial.
        \item \textbf{Retorno:} Regresa al punto 2 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Rechazo sin justificación} \\
    \textit{Condición:} El actor no proporciona motivos para el rechazo.
    \begin{itemize}[nosep]
        \item[C-1:] El actor deja el campo de justificación vacío.
        \item[C-2:] El sistema acepta el rechazo sin observaciones.
        \item[C-3:] El sistema registra "Sin justificación especificada".
        \item \textbf{Retorno:} Continúa en el punto 4 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUdiecisiete
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU17.}
    \label{fig:cu17}
\end{figure}
...
\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Error en el servicio de sellado digital} \\
    \textit{Condición:} El servicio de firma electrónica no está disponible.
    \begin{itemize}[nosep]
        \item[A-1:] El sistema detecta el error de conexión o generación.
        \item[A-2:] El sistema muestra el mensaje \hyperlink{msg:MSG42}{MSG42}.
        \item[A-3:] El sistema sugiere intentar nuevamente más tarde.
        \item \textbf{Retorno:} Termina el caso de uso sin descargar.
    \end{itemize}
    \item \textbf{Trayectoria B: Acuse no disponible para el estatus actual} \\
    \textit{Condición:} El trámite está en un estatus que no permite generar acuse.
    \begin{itemize}[nosep]
        \item[B-1:] El sistema verifica el estatus del trámite.
        \item[B-2:] El sistema muestra mensaje indicando que el acuse no está disponible.
        \item[B-3:] El sistema explica qué estatus habilitan la descarga.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectoria C: Descarga de acuse de conciliación} \\
    \textit{Condición:} El acuse corresponde a un acta de conciliación aceptada.
    \begin{itemize}[nosep]
        \item[C-1:] El sistema genera el acta con términos del acuerdo.
        \item[C-2:] El sistema incluye las firmas digitales de ambas partes.
        \item[C-3:] El sistema añade un sello de "Concluido por Conciliación".
        \item \textbf{Retorno:} Continúa en el punto 6 de la trayectoria principal.
    \end{itemize}
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \figCUdieciocho
    \shorthandon{"}
    \caption{Diagrama de Caso de Uso CU18.}
    \label{fig:cu18}
\end{figure}
...
\textbf{Campo} & \textbf{Detalle} \\ \hline
\textbf{Actor} & Quejoso \\ \hline
\textbf{Propósito} & Ofrecer una vista detallada y transparente de toda la información y actividad relacionada con un folio de queja específico. \\ \hline
\textbf{Entradas} & Selección de un folio desde el tablero de trámites (\hyperlink{anexo:casos_uso}{CU08}). \\ \hline
\textbf{Origen} & Base de Datos (Tablas: Quejas, Evidencias, Notificaciones, Historial\_Estados). \\ \hline
\textbf{Salidas} & Despliegue de narrativa completa, visor de evidencias, línea del tiempo de estatus. \\ \hline
\textbf{Destino} & Pantalla de expediente detallado [GQ]-UI05. \\ \hline
\textbf{Precondiciones} & 
\begin{itemize}[nosep, leftmargin=*]
    \item El actor debe haber iniciado sesión (\hyperlink{anexo:casos_uso}{CU02}).
    \item El trámite seleccionado debe pertenecer al ID\_Usuario activo (validación de propiedad).
\end{itemize} \\ \hline
\textbf{Postcondiciones} & 
\begin{itemize}[nosep, leftmargin=*]
    \item El sistema permite la navegación hacia la descarga de acuses (\hyperlink{anexo:casos_uso}{CU17}) si el estatus lo permite.
\end{itemize} \\ \hline
\textbf{Errores} & 
\begin{itemize}[nosep, leftmargin=*]
    \item \hyperlink{err:E23}{E1}: El folio no existe o el usuario no tiene permisos de acceso (MSG43).
\end{itemize} \\ \hline
\end{tabular}
\caption{Descripción del Caso de Uso CU18.}
\label{tab:cu18_especificacion}
\end{table}

\subsubsection{Trayectorias del CU18}
\textbf{Trayectoria principal:}
\begin{enumerate}[nosep]
    \item El actor selecciona un trámite específico en el tablero \textbf{[GQ]-UI03}.
    \item El sistema valida los permisos de acceso para asegurar que el quejoso sea el dueño del folio (\hyperlink{err:E23}{Error E1}).
    \item El sistema recupera la información de la narrativa, anexos multimedia y notificaciones.
    \item El sistema despliega la pantalla \textbf{[GQ]-UI05} organizada por secciones (Datos, Pruebas, Estatus).
    \item El actor navega por las pestañas de información para consultar el progreso de su denuncia.
    \item El actor puede invocar al \hyperlink{anexo:casos_uso}{CU17} para descargar el acuse de recibo si está disponible.
\end{enumerate}

\textbf{Trayectorias alternativas:}
\begin{itemize}[leftmargin=*]
    \item \textbf{Trayectoria A: Acceso denegado por permisos insuficientes} \\
    \textit{Condición:} El actor intenta acceder a un trámite que no le pertenece.
    \begin{itemize}[nosep]
        \item[A-1:] El sistema valida que el ID\_Usuario no corresponde al folio.
        \item[A-2:] El sistema muestra el mensaje \hyperlink{msg:MSG43}{MSG43}.
        \item[A-3:] El sistema redirecciona al tablero de trámites.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
    \item \textbf{Trayectoria B: Visualización de evidencias} \\
    \textit{Condición:} El actor desea ver un archivo de evidencia adjunto.
    \begin{itemize}[nosep]
        \item[B-1:] El actor selecciona un archivo de la lista de evidencias.
        \item[B-2:] El sistema abre un visor modal o descarga el archivo.
        \item[B-3:] El sistema registra la visualización en el log.
        \item \textbf{Retorno:} Regresa al punto 5 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria C: Línea de tiempo de estatus} \\
    \textit{Condición:} El actor consulta el historial de cambios de estatus.
    \begin{itemize}[nosep]
        \item[C-1:] El actor selecciona la pestaña "Historial" o "Línea de tiempo".
        \item[C-2:] El sistema muestra la cronología de todos los cambios de estatus.
        \item[C-3:] El sistema incluye fechas, horas y usuarios responsables.
        \item \textbf{Retorno:} Regresa al punto 5 de la trayectoria principal.
    \end{itemize}
    \item \textbf{Trayectoria D: Error al cargar los datos del expediente} \\
    \textit{Condición:} Fallo en la consulta de la base de datos o timeout.
    \begin{itemize}[nosep]
        \item[D-1:] El sistema detecta el error en la recuperación de datos.
        \item[D-2:] El sistema muestra mensaje de error genérico.
        \item[D-3:] El sistema sugiere recargar la página o intentar más tarde.
        \item \textbf{Retorno:} Termina el caso de uso.
    \end{itemize}
\end{itemize}
