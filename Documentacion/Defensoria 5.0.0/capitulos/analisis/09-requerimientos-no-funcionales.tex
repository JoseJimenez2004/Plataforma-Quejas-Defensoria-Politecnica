...
RNF-01 & El acceso administrativo debe estar restringido mediante el modelo RBAC (Role-Based Access Control)[cite: 1]. & Seguridad \\
...
RNF-09 & La clasificación automática de quejas por el motor de IA debe realizarse en un tiempo menor a 5 segundos[cite: 1]. & Rendimiento \\
\rowcolor[HTML]{F2F4F7} 
