...
La figura \ref{fig:casos_uso_quejoso} presenta los casos de uso que definen el comportamiento funcional del sistema desde la perspectiva del quejoso. Donde se
...
\setlength{\parskip}{0pt}
\begin{longtable}{|p{3.5cm}|p{2cm}|p{2.5cm}|p{7cm}|}
\caption{Especificación de Caso de Uso CU05: Consultar estatus}
\label{tab:cu05_consultar_estatus} \\
\hline
\textbf{Identificador} & CU05 & \textbf{Nombre} & Consultar estatus \\ \hline
\textbf{Actor Principal} & \multicolumn{3}{p{11.5cm}|}{Quejoso} \\ \hline
...
\textbf{Postcondiciones} & \multicolumn{3}{p{11.5cm}|}{El usuario visualiza el estado de su trámite en tiempo real.} \\ \hline
\end{longtable}
\endgroup
...
\textbf{Actor Principal} & \multicolumn{3}{p{11.5cm}|}{Quejoso} \\ \hline
\textbf{Descripción} & \multicolumn{3}{p{11.5cm}|}{Permite al usuario consultar toda la información detallada de un expediente específico, incluyendo la narrativa, evidencias y bitácora de cambios.} \\ \hline
\textbf{Disparador} & \multicolumn{3}{p{11.5cm}|}{El usuario selecciona una queja de la lista mediante el botón ``Ver detalles''.} \\ \hline
\textbf{Precondiciones} & \multicolumn{3}{p{11.5cm}|}{El usuario debe tener permisos de acceso sobre el folio solicitado.} \\ \hline
\textbf{Flujo Principal} & \multicolumn{3}{p{11.5cm}|}{1. El Quejoso selecciona el registro.\newline 2. El Sistema realiza una petición GET al backend con el ID del trámite.\newline 3. El Sistema despliega una vista completa con datos del quejoso, hechos y archivos adjuntos.\newline 4. El Sistema muestra el historial de estatus del expediente.} \\ \hline
...
\textbf{Situaciones de error} & \multicolumn{3}{p{11.5cm}|}{El folio solicitado no pertenece al usuario autenticado (intento de acceso no autorizado).} \\ \hline
\textbf{Estado en error} & \multicolumn{3}{p{11.5cm}|}{El sistema muestra una pantalla de ``403 Prohibido'' o redirige al Dashboard con un error de seguridad.} \\ \hline
...
\textbf{Actor Principal} & \multicolumn{3}{p{11.5cm}|}{Quejoso} \\ \hline
\textbf{Descripción} & \multicolumn{3}{p{11.5cm}|}{Proporciona un listado tabular de todos los expedientes registrados por el usuario, permitiendo el filtrado por estatus o fecha.} \\ \hline
...
\textbf{Disparador} & \multicolumn{3}{p{11.5cm}|}{El usuario selecciona ``Nueva Denuncia'' dentro del Dashboard.} \\ \hline
...
\textbf{Flujos Alternativos} & \multicolumn{3}{p{11.5cm}|}{\textbf{3a. Guardar Borrador:}\newline 1. El usuario selecciona ``Guardar para después''.\newline 2. El sistema almacena los datos sin generar folio oficial aún.} \\ \hline
...
\textbf{Flujos Alternativos} & \multicolumn{3}{p{11.5cm}|}{\textbf{1a. Limpiar notificaciones:}\newline 1. El usuario selecciona ``Marcar todas como leídas''.} \\ \hline
...
\setlength{\parskip}{0pt}
\begin{longtable}{|p{3.5cm}|p{2cm}|p{2.5cm}|p{7cm}|}
\caption{Especificación de Caso de Uso CU16: Revisar Propuesta de Conciliación}
\label{tab:cu16_revisar_propuesta} \\
\hline
\textbf{Identificador} & CU16 & \textbf{Nombre} & Revisar Propuesta de Conciliación \\ \hline
\textbf{Actor Principal} & \multicolumn{3}{p{11.5cm}|}{Quejoso} \\ \hline
\textbf{Descripción} & \multicolumn{3}{p{11.5cm}|}{Permite al usuario visualizar la medida o solución propuesta por el defensor para resolver la queja de manera amistosa.} \\ \hline
\textbf{Disparador} & \multicolumn{3}{p{11.5cm}|}{El usuario abre una notificación de ``Propuesta de Conciliación''.} \\ \hline
\textbf{Precondiciones} & \multicolumn{3}{p{11.5cm}|}{La queja debe estar en estatus ``PROPUESTA ENVIADA''.} \\ \hline
\textbf{Flujo Principal} & \multicolumn{3}{p{11.5cm}|}{1. El Sistema despliega el documento o texto de la propuesta redactada por el Defensor.\newline 2. El Quejoso analiza los términos de la solución.\newline 3. El Sistema habilita los botones para aceptar o rechazar (CU17).} \\ \hline
\textbf{Flujos Alternativos} & \multicolumn{3}{p{11.5cm}|}{\textbf{2a. Solicitar aclaración:}\newline 1. El usuario utiliza el canal de contacto para dudas antes de decidir.} \\ \hline
...
\setlength{\parskip}{0pt}
\begin{longtable}{|p{3.5cm}|p{2cm}|p{2.5cm}|p{7cm}|}
\caption{Especificación de Caso de Uso CU18: Justificar Rechazo de Propuesta}
\label{tab:cu18_justificar_rechazo} \\
\hline
\textbf{Identificador} & CU18 & \textbf{Nombre} & Justificar Rechazo de Propuesta \\ \hline
\textbf{Actor Principal} & \multicolumn{3}{p{11.5cm}|}{Quejoso} \\ \hline
\textbf{Descripción} & \multicolumn{3}{p{11.5cm}|}{Permite al usuario proporcionar los motivos detallados por los cuales no acepta la propuesta de solución emitida por la Defensoría.} \\ \hline
\textbf{Disparador} & \multicolumn{3}{p{11.5cm}|}{El usuario selecciona la opción ``Rechazar'' dentro de la revisión de la propuesta (CU16).} \\ \hline
\textbf{Precondiciones} & \multicolumn{3}{p{11.5cm}|}{El expediente debe estar en estatus ``PROPUESTA ENVIADA''.} \\ \hline
\textbf{Flujo Principal} & \multicolumn{3}{p{11.5cm}|}{1. El Quejoso selecciona el botón ``Rechazar''.\newline 2. El Sistema despliega un cuadro de texto obligatorio para la justificación.\newline 3. El Quejoso redacta los argumentos del rechazo.\newline 4. El Quejoso selecciona ``Confirmar rechazo''.\newline 5. El Sistema almacena el comentario y actualiza el estatus del expediente a ``EN REVISIÓN''.\newline 6. El Sistema notifica al Defensor sobre el rechazo.} \\ \hline
\textbf{Flujos Alternativos} & \multicolumn{3}{p{11.5cm}|}{\textbf{4a. Cancelar acción:}\newline 1. El usuario cierra el cuadro de texto sin guardar.\newline 2. El sistema mantiene el estatus de la queja como ``PROPUESTA ENVIADA''.} \\ \hline
\textbf{Situaciones de error} & \multicolumn{3}{p{11.5cm}|}{El usuario intenta enviar el rechazo con el campo de justificación vacío.} \\ \hline
\textbf{Estado en error} & \multicolumn{3}{p{11.5cm}|}{El sistema no procesa el cambio de estatus y resalta el campo de texto indicando que es requerido.} \\ \hline
\textbf{Postcondiciones} & \multicolumn{3}{p{11.5cm}|}{La propuesta queda invalidada y el expediente regresa a la bandeja del defensor para un nuevo análisis.} \\ \hline
\end{longtable}
\endgroup
