...
\begin{enumerate}
    \item \textbf{Spring Boot Actuator:} Proporciona herramientas esenciales para la \textit{observabilidad}. A través de diversos \textit{endpoints} HTTP, permite monitorear el estado de salud (\textit{health}), recolectar métricas de rendimiento y auditar el comportamiento del sistema en tiempo real.
