...
* The original package name 'ipn.escom.defensoria.notificaciones-service' is invalid and this project uses 'ipn.escom.defensoria.notificaciones_service' instead.
