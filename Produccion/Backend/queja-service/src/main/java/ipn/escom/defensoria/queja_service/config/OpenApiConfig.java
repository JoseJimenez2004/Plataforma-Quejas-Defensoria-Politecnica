...
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI quejaServiceOpenAPI() {
        final String esquemaJwt = "bearerAuth";
        return new OpenAPI()
                .info(new Info()
                        .title("Queja Service — Defensoría de los Derechos Politécnicos")
                        .description("Registro y consulta de quejas, folios y evidencias "
