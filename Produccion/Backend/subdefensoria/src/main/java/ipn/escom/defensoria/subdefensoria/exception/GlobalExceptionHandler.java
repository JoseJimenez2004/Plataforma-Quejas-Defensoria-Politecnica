...
/**
 * Centraliza el formato de error para toda la API, igual que en
 * Primer Contacto: el front siempre recibe un JSON entendible
 * {"error": "..."} con el codigo de estado correcto.
 */
